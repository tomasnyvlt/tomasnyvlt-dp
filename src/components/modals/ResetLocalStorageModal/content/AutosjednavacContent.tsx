...
import { VehicleImageType } from '@src/types/autosjednavac/vehicleImageType';
import { AutoSjednavacFetchRequestType } from '@src/types/autosjednavac/AutoSjednavacFetchType';
