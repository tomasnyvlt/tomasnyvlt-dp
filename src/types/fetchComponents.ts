...
export interface SpzFetchFieldType extends BasicComponentType {
  ...
  fields: Array<DesignComponentType | LayoutFieldsType | FormFieldsType | FetchComponentType>;
}
...
export type FetchComponentType = SpzFetchFieldType | RZFetchFieldType | FleetRestAddVehicle;
