...
import { confVehicleInsuranceFeEnumsVehicleUsePurposeFe } from '../../../../diplomova-prace-next/codetables/generated/conf-vehicle-insurance-fe-enums-vehicle-use-purpose-fe.js';
